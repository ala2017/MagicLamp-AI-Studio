...
Create a folder for your skill in one of the skill directoriesAdd a `SKILL.md` file inside that folder
...
**Discovery**: When a conversation starts, the agent sees a list of available skills with their names and descriptions**Activation**: If a skill looks relevant to your task, the agent reads the full `SKILL.md` content**Execution**: The agent follows the skill's instructions while working on your task
